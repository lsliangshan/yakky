...
```bash
yakky create [--repositry <name>] [--template <name>]
```
...
```bash
yakky repo add [--name [模板仓库名称]] [--url [模板仓库地址]]
```
...
```bash
yakky repo remove [--name [模板仓库名称]]
yakky repo rm [--name [模板仓库名称]]
```
...
```bash
yakky sample-file [--repositry <name>] [--template <name>]
```
